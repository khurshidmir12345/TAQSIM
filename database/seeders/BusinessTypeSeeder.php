...
class BusinessTypeSeeder extends Seeder
{
    ...
    {
        /** @var array<string, array{name_en: string, terminology: array<string, string>}> $english */
        $english = require database_path('data/business_type_english.php');
        ...
        foreach ($types as &$type) {
            $key = $type['key'];
            $type['name_en'] = $english[$key]['name_en'];
            $type['terminology']['en'] = $english[$key]['terminology'];
        }
        unset($type);
