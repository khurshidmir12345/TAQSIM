...
return [
    ...
    'errors' => [
        ...
        'batch_unit_duplicate' => 'Воҳиди партия бо ин ном аллакай мавҷуд аст.',
        'batch_unit_in_use' => 'Ин воҳид дар ретсепт истифода шудааст — аввал ретсептро тағйир диҳед.',
        'batch_unit_limit' => 'Ҳадди воҳидҳои махсус расид (20).',
    ...
    'auth' => [
        ...
        'phone_change_code_sent' => 'Рамзи тасдиқ ба рақами нав фиристода шуд.',
        'phone_changed' => 'Рақами телефон иваз шуд.',
        'phone_change_taken' => 'Ин рақам аллакай сабти ном шудааст. Рақами дигар ворид кунед.',
        'phone_change_same' => 'Ин рақами ҳозираи шумост.',
