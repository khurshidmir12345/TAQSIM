...
return [
    ...
    'errors' => [
        ...
        'batch_unit_duplicate' => 'Бұл атаумен партия бірлігі бар.',
        'batch_unit_in_use' => 'Бұл бірлік рецептте қолданылған — алдымен рецептті өзгертіңіз.',
        'batch_unit_limit' => 'Арнайы бірліктер шегіне жетті (20).',
