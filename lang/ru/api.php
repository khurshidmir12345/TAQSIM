...
return [
    ...
    'errors' => [
        ...
        'feature_unavailable' => 'Этот раздел не подключён к вашему аккаунту.',
        ...
        'batch_unit_duplicate' => 'Единица партии с таким названием уже есть.',
        'batch_unit_in_use' => 'Эта единица используется в рецепте — сначала измените рецепт.',
        'batch_unit_limit' => 'Достигнут лимит пользовательских единиц (20).',
