...
return [
    ...
    'errors' => [
        ...
        'batch_unit_duplicate' => 'Bu isimde bir parti birimi zaten var.',
        'batch_unit_in_use' => 'Bu birim bir tarifte kullanılıyor — önce tarifi değiştirin.',
        'batch_unit_limit' => 'Özel birim sınırına ulaşıldı (20).',
    ...
    'auth' => [
        ...
        'phone_change_code_sent' => 'Yeni numaraya doğrulama kodu gönderildi.',
        'phone_changed' => 'Telefon numarası değiştirildi.',
        'phone_change_taken' => 'Bu numara zaten kayıtlı. Başka bir numara girin.',
        'phone_change_same' => 'Bu zaten mevcut numaranız.',
