...
return [
    'notice' => [
        ...
        'ending_today' => "Здравствуйте!\n\nСрок полного доступа в Taqseem заканчивается сегодня.\n\nС завтрашнего дня разделы «Статистика», «Заказы» и «Сотрудники» будут закрыты. Главная, товары и рецепты, производство, возвраты и касса продолжат работать бесплатно.\n\nЧтобы продолжить пользоваться всеми возможностями, оформите премиум-тариф — свяжитесь с администратором: :contact",
