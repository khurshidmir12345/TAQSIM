...
return [
    ...
    'errors' => [
        'subscription_required' => 'Срок подписки истёк. Выберите тариф, чтобы продолжить.',
        'plan_limit_reached' => 'Достигнут лимит тарифа. Перейдите на более высокий тариф.',
        'insufficient_balance' => 'Недостаточно средств на балансе. Пополните баланс.',
        'yearly_not_available' => 'Для этого тарифа годовая подписка недоступна.',
        'generic' => 'Ошибка',
    ...
    'employees' => [
        ...
        'seat_suspended' => 'Срок оплаты места сотрудника истёк. Пополните баланс.',
        'owner_subscription_inactive' => 'Подписка владельца истекла. Свяжитесь с владельцем.',
    ],
];
