...
return [
    ...
    'errors' => [
        ...
        'batch_unit_duplicate' => 'A batch unit with this name already exists.',
        'batch_unit_in_use' => 'This unit is used by a recipe — change the recipe first.',
        'batch_unit_limit' => 'Custom unit limit reached (20).',
    ...
    'auth' => [
        ...
        'phone_change_code_sent' => 'Verification code sent to the new number.',
        'phone_changed' => 'Phone number changed.',
        'phone_change_taken' => 'This number is already registered. Enter a different number.',
        'phone_change_same' => 'This is already your current number.',
